        ...
        <div class="col-md-10">
            <div class="panel panel-flat">
                ...
                <div class="panel-body">
                    <form id="form_noticia" action="{{ route('admin.noticias.store') }}" class="form-validate-jquery"
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label>Título:</label>
                                        <input name="titulo" type="text" class="form-control text-uppercase" required
                                               autofocus>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <label>
                                            <input name="destaque" value="1" type="checkbox" data-off-color="danger"
                                                   data-on-text="Sim" data-off-text="Não" class="switch">
                                        </label>
                                    </div>
                                </div>
